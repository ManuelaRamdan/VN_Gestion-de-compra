...
-- ==========================================
-- 3. Inserción de datos frescos (Grupo Ruta)
-- ==========================================
...
-- ==========================================
-- 4. Inserción de datos frescos (Sector Permiso)
-- ==========================================
...
8	PERM_UPLOADS
8	PERM_SOLICITUDES_CREAR
8	PERM_SOLICITUDES_VER
8	PERM_PRODUCTOS_VER
8	PERM_PRIORIDADES_VER
8	PERM_PROVEEDORES_VER
8	PERM_RECLAMOS
8	PERM_PRODUCTOS_ADMIN
8	PERM_USUARIOS_ADMIN
8	PERM_PROVEEDORES_ADMIN
8	PERM_SOLICITUDES_ADMIN
8	PERM_APROBACIONES_ADMIN
8	PERM_PRIORIDADES_ADMIN
2	PERM_UPLOADS
