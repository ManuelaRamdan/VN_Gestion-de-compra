...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .hasAnyAuthority("PERM_COMPRAS_VER", "PERM_COMPRAS_GESTIONAR")
                ...
                .hasAnyAuthority("PERM_EVAL_PROVEEDOR_VER", "PERM_EVAL_PROVEEDOR_EDITAR")
                .requestMatchers("/api/evalProveedor/**")
                .hasAuthority("PERM_EVAL_PROVEEDOR_EDITAR")
                .requestMatchers(HttpMethod.GET, "/api/evalEntrega/**")
                .hasAnyAuthority("PERM_EVAL_ENTREGA_VER", "PERM_EVAL_ENTREGA_EDITAR")
                ...
                .hasAnyAuthority("PERM_DOCUMENTACION_VER", "PERM_DOCUMENTACION_DESCARGAR")
                ...
                .hasAnyAuthority("PERM_CIERRES_VER", "PERM_CIERRES_GESTIONAR")
