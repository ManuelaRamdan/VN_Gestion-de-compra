...
                    <Link to="/" className="flex items-center gap-2 font-bold text-lg text-[#1C5B5A] shrink-0 z-10 bg-white pr-2 xl:pr-6">
...
                                    to={link.path}
                                    /* text-[11px] en pantallas normales, text-sm en pantallas gigantes */
                                    className={`flex items-center h-16 text-[11px] xl:text-sm font-bold px-1.5 xl:px-3 border-b-2 transition-all whitespace-nowrap ${
...
                                                    className={`pl-10 pr-6 py-3 text-sm font-bold transition-colors ${
                                                        location.pathname === subLink.path
